      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-400 leading-relaxed mb-3">
            Complete India GCC Reference — 4 Parts, 153 chapters on landscape, maturity models, AI, deep tech, M&A, regulation, sector playbooks and 2030 scenarios. Fully navigable with search &amp; glossary.
          </p>
