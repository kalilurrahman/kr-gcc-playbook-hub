  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        details: ["96% of GCCs established after FY2021 launched with a product or portfolio mandate from day one (49% AI-first)", "Maturity that historically took 10 years is now happening in under 5", "Verified Maturity Mix: nearly half of India GCCs already operate at advanced (Portfolio/Transformation-Hub) maturity; ~75% have the potential within five years and three-quarters are projected to reach it by 2030", "Reading the Band Shares: the per-band percentages above are indicative — public FY2026 coverage reports the advanced (Portfolio + Transformation) share at roughly half, so treat the individual splits as directional rather than exact", "Implication: Founding governance, leadership, AI readiness, and portfolio scope must be designed at launch", "Operating Model: Structure, governance, decision rights, talent maturity, digital capabilities, business alignment, innovation output, and cultural integration"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        details: ["Key Areas: SEZ/STPI approvals, labor laws, tax compliance, data privacy", "India-Specific: GST, PF, ESI, contract labor regulations", "2025-26 Regulatory Clock: DPDP Rules notified 13 Nov 2025 — consent managers live 13 Nov 2026, substantive obligations 13 May 2027; all four Labour Codes in force 21 Nov 2025 (basic pay ≥50% of wages)", "Budget 2026 Tax Certainty: safe-harbour threshold raised ₹300cr → ₹2,000cr, uniform 15.5% margin, automated approval with a 5-year election (from 1 Apr 2026)", "Deep Dive: see Playbook Part III, Chapter 144 — 'The 2025-26 Regulatory Reset and State Policy Landscape' (incl. 10-state GCC policy matrix)", "Solution - Expert Partners: Local legal and compliance advisors; strong internal controls and audit trails", "Solution - Data Security: DPDP, GDPR, SOC2, ISO certifications", "Common Pitfall: Underestimating compliance causes deal failures in exits"],
      },
      {
